...
public class Simpletron extends SimpletronOperationCodes {
    ...
    private void execute() {
        ...
        do {
            ...
            validHex = codeInputter.nextLine();
            //INCISO D) ----------------------------------------------------------------------------------------
            //If the user enters a hexadecimal value, convert it to an integer
            if (validHex.endsWith("h") || validHex.endsWith("H")){
                instructionInput = Integer.parseInt(validHex.substring(0, validHex.length() - 1), 16);
            }
            else{
